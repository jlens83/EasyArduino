...
Blockly.Blocks['repetir_veces'] = {
		  ...
		  init: function() {
			    this.setColour(290);
			    this.appendDummyInput()
			        .appendField("Ejecutar Programa ") 
			        .appendField(new Blockly.FieldTextInput('0', Blockly.FieldTextInput.numberValidator), 'NUM')
			        .appendField("veces") 
			    this.appendStatementInput('BLOQ');
			    this.appendDummyInput()
		    		.appendField("Despues hacer:")
		    	this.appendStatementInput('BLOQ2');
			    this.setPreviousStatement(true, null);
			    this.setNextStatement(true, null);
			    this.setTooltip('Ejecuta un programa solo el numero de veces indicado');
		  }
};
...
Blockly.Blocks['ejecutar_durante'] = {
		  ...
		  init: function() {
			    this.setColour(290);
			    this.appendDummyInput()
			        .appendField("Ejecutar Programa Durante") 
			        .appendField(new Blockly.FieldTextInput('0', Blockly.FieldTextInput.numberValidator), 'NUM')
			        .appendField("[ms]") 
			    this.appendStatementInput('BLOQ');
			    this.appendDummyInput()
			    ...
			    this.setPreviousStatement(true, null);
			    this.setNextStatement(true, null);
			    this.setTooltip('Ejecuta un programa durante el tiempo indicado');
		  }
};
...
Blockly.Blocks['ejecutar_intervalo'] = {
		  ...
		  init: function() {
			    this.setColour(290);
			    this.appendDummyInput()
			        .appendField("Ejecutar a intervalos de") 
			        .appendField(new Blockly.FieldTextInput('0', Blockly.FieldTextInput.numberValidator), 'NUM')
			        .appendField("[ms]") 
			    this.appendStatementInput('BLOQ');
			    this.appendDummyInput()
			    	.appendField("Entre intervalos hacer:")
			    this.appendStatementInput('BLOQ2');
			    this.setPreviousStatement(true, null);
			    this.setNextStatement(true, null);
			    this.setTooltip('Ejecuta un programa durante a intervalos de tiempo');
		  }
};
...
Blockly.Blocks['eliminar'] = {
		  ...
		  init: function() {
			    this.setColour(270);
			    this.appendDummyInput()
			        .appendField("Eliminar Programa") 
			    this.setPreviousStatement(true, null);
			    this.setNextStatement(true, null);
			    this.setTooltip('Elimina un programa');
		  }
};
