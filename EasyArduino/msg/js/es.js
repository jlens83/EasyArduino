...
//Personalizados
Blockly.Msg.LED_ESTADO = "Accion";
Blockly.Msg.LED_ENCENDER = "Encender";
Blockly.Msg.LED_APAGAR = "Apagar";

Blockly.Msg.BOCINA = "Bocina";
Blockly.Msg.TONO = "Tono ";
Blockly.Msg.TIEMPO = "Duracion [ms] ";
Blockly.Msg.DESCRIPCION = "Emite un tono segun el valor indicado";

Blockly.Msg.LCD = "Pantalla LCD   ";
Blockly.Msg.LCD_DESCRIPCION = "Configura la pantalla";
Blockly.Msg.LCD_IMPRIMIR = "Pantalla LCD: Imprimir ";
Blockly.Msg.LCD_IMPRIMIR_FILA = "Fila";
Blockly.Msg.LCD_IMPRIMIR_TEXTO = "       Texto";
Blockly.Msg.LCD_IMPRIMIR_DESCRIPCION = "Imprime texto en la pantalla.";
Blockly.Msg.LCD_BORRAR = "Pantalla LCD: Borrar ";
Blockly.Msg.LCD_BORRAR_DESCRIPCION = "Borra el texto de la pantalla.";

Blockly.Msg.MOTOR_DC = "Motor";
Blockly.Msg.MOTOR_DC_PARAR = "Parar";
Blockly.Msg.MOTOR_DC_ADELANTE = "Adelante";
Blockly.Msg.MOTOR_DC_ATRAS = "Atras";
Blockly.Msg.MOTOR_DESCRIPCION = "Motor de corriente continua DC";

Blockly.Msg.MOTOR_CONTROLADOR = "Controlador Motores      ";
Blockly.Msg.MOTOR_CONTROLADOR_SI = "Si";
Blockly.Msg.MOTOR_CONTROLADOR_DESCRIPCION = 'Controlador de motores de corriente continua';

Blockly.Msg.MOTOR_ADELANTE = "Adelante   Motor";
Blockly.Msg.MOTOR_VELOCIDAD = "  Velocidad [0-250] ";
Blockly.Msg.MOTOR_ADELANTE_DESCRIPCION = "Mueve el motor hacia adelante";
Blockly.Msg.MOTOR_ATRAS = "Atras   Motor";
Blockly.Msg.MOTOR_ATRAS_DESCRIPCION = "Mueve el motor hacia atras";
Blockly.Msg.MOTOR_PARAR = "Parar   Motor";
Blockly.Msg.MOTOR_PARAR_DESCRIPCION = "Detiene el motor";

Blockly.Msg.PIN_DIGITAL = "Poner pin Digital  PIN#";
Blockly.Msg.PIN_ESTADO = " Estado";
Blockly.Msg.PIN_ESTADO_ALTO = "ALTO";
Blockly.Msg.PIN_ESTADO_BAJO = "BAJO";
Blockly.Msg.PIN_DIGITAL_DESCRIPCION = 'Coloca el pin indicado en estado ALTO o BAJO';
Blockly.Msg.PIN_ANALOGICO = "Poner pin analogico PIN#";
Blockly.Msg.PIN_VALOR = " valor";
Blockly.Msg.PIN_ANALOGICO_DESCRIPCION = 'Poner en el pin analogico un valor entre 0 y 255';

Blockly.Msg.IMPRIMIR_PUERTO_SERIE = "Imprimir en puerto serie";
Blockly.Msg.IMPRIMIR_PUERTO_SERIE_DESCRIPCION = "Imprimir datos en el puerto serie/consola.";

Blockly.Msg.LED_PLACA = "LED de PLACA    Accion";
Blockly.Msg.LED_PLACA_DESCRIPCION = "Enciende o apaga el LED de la placa";



Blockly.Msg.BOTON = "Pulsar Boton";
Blockly.Msg.ULTRASONIDOS = "Distancia por Ultrasonidos    ";
Blockly.Msg.ULTRASONIDOS_DESCRIPCION = "Mide la distancia hasta un obstaculo en centimetros";
Blockly.Msg.MOVIMIENTO = "Detecta Movimiento";
Blockly.Msg.MOVIMIENTO_DESCRIPCION = "Cuando alguien se mueve en el angulo que esta detectando, la salida del sensor esta en ALTA.";
Blockly.Msg.SIGUELINEAS = "Sigue Lineas";
Blockly.Msg.SIGUELINEAS_DESCRIPCION = "Devolvera 0 cuando se detecta linea blanca, y 1 cuando se detecta linea negra";
Blockly.Msg.SENSOR_LUZ = "Sensor de Luz";
Blockly.Msg.SENSOR_LUZ_DESCRIPCION = "Indica la intensidad de luz";
Blockly.Msg.TEMPERATURA = "Temperatura";
Blockly.Msg.TEMPERATURA_DESCRIPCION = "Indica la temperatura en ℃";
Blockly.Msg.POTENCIOMETRO = "Potenciometro";
Blockly.Msg.POTENCIOMETRO_DESCRIPCION = "Cambia la intensidad de la corriente";

Blockly.Msg.READ_PIN_DIGITAL = "Leer pin digital PIN#";
Blockly.Msg.READ_PIN_ANALOGICO = "Leer pin analogico PIN#";
Blockly.Msg.READ_PIN_ANALOGICO_DESCRIPCION = 'Devuelve un valor entre 0 y 1024';



Blockly.Msg.RANDOM = "Aleatorio entre ";
Blockly.Msg.RANDOM_AND = "y ";
Blockly.Msg.RANDOM_DESCRIPCION = "Genera un numero aleatorio en el rango que deseamos";
Blockly.Msg.MAPEAR = "Mapear ";
Blockly.Msg.MAPEAR_VALOR = "valores [0-";
Blockly.Msg.MAPEAR_DESCRIPCION = "Permite mapear una variable que vaya de 0 a 1023 al rango que deseamos";



Blockly.Msg.ESPERAR = "Esperar ";
Blockly.Msg.ESPERAR_UNIDADES = "milisegundos";
Blockly.Msg.ESPERAR_DESCRIPCION = "Retrasa el tiempo indicado";

Blockly.Msg.EJECUTAR_PROGRAMA_SI = "Ejecutar Programa Si";
Blockly.Msg.EJECUTAR_PROGRAMA_SI_DESCRIPCION = "Inicia un programa si se cumple la condicion";

Blockly.Msg.REPETIR_SIEMPRE = "Repetir Siempre";
Blockly.Msg.REPETIR_SIEMPRE_DESCRIPCION = "Ejecuta continuamente el programa";

Blockly.Msg.REPETIR_MIENTRAS_HASTA = "Repetir";
Blockly.Msg.REPETIR_HACER = "hacer";
Blockly.Msg.REPETIR_HASTA = "hasta";
Blockly.Msg.REPETIR_MIENTRAS = "mientras";
Blockly.Msg.REPETIR_HASTA_DESCRIPCION = "Repetir hasta que el valor es verdadero";
Blockly.Msg.REPETIR_MIENTRAS_DESCRIPCION = "Repetir mientras el valor es verdadero";

Blockly.Msg.FOR = "Hacer";
Blockly.Msg.FOR_ESTO = "esto";
Blockly.Msg.FOR_VECES = "veces ";



Blockly.Msg.INICIO_PROGRAMA = "Inicio  Programa      ";
Blockly.Msg.INICIO_PROGRAMA_DESCRIPCION = "Inicio de un programa";
Blockly.Msg.REPETIR_PROGRAMA_VECES = "Ejecutar Programa ";
Blockly.Msg.REPETIR_PROGRAMA_VECES_NUM = "veces";
Blockly.Msg.REPETIR_PROGRAMA_VECES_HACER = "Despues hacer:";
Blockly.Msg.REPETIR_PROGRAMA_VECES_DESCRIPCION = "Ejecuta un programa solo el numero de veces indicado";
Blockly.Msg.REPETIR_PROGRAMA_DURANTE = "Ejecutar Programa Durante";
Blockly.Msg.REPETIR_PROGRAMA_DURANTE_TIME = "[ms]";
Blockly.Msg.REPETIR_PROGRAMA_DURANTE_HACER = "Despues hacer:";
Blockly.Msg.REPETIR_PROGRAMA_DURANTE_DESCRIPCION = "Ejecuta un programa durante el tiempo indicado";
Blockly.Msg.REPETIR_PROGRAMA_INTERVALO = "Ejecutar a intervalos de";
Blockly.Msg.REPETIR_PROGRAMA_INTERVALO_TIME = "[ms]";
Blockly.Msg.REPETIR_PROGRAMA_INTERVALO_HACER = "Entre intervalos hacer:";
Blockly.Msg.REPETIR_PROGRAMA_INTERVALO_DESCRIPCION = "Ejecuta un programa durante a intervalos de tiempo";
Blockly.Msg.BORRAR_PROGRAMA = "Eliminar Programa";
Blockly.Msg.BORRAR_PROGRAMA_DESCRIPCION = "Elimina un programa";



Blockly.Msg.SERVO_CONTINUA = "Servo Rotacion Continua";
Blockly.Msg.SERVO_CONTINUA_SENTIDO = "Girar en sentido ";
Blockly.Msg.SERVO_CONTINUA_HORARIO = "Horario";
Blockly.Msg.SERVO_CONTINUA_ANTIHORARIO = "AntiHorario";
Blockly.Msg.SERVO_CONTINUA_DETENER = "Detener";
Blockly.Msg.SERVO_CONTINUA_DESCRIPCION = "Hace girar el servo";

Blockly.Msg.SERVO_GRADOS = "Grados a girar (0-180) ";
Blockly.Msg.SERVO_GRADOS_DESCRIPCION = "Mueve el servo entre 0 y 180 grados";

Blockly.Msg.ROBOT_PIN_IZQUIERDO = "Servo Izquierda  PIN#";
Blockly.Msg.ROBOT_PIN_DERECHO = "Servo Derecha   PIN#";
Blockly.Msg.ROBOT_UP = "Adelante    ";
Blockly.Msg.ROBOT_UP_DESCRIPCION = "Mueve los servos hacia adelante";
Blockly.Msg.ROBOT_DOWN = "Atras         ";
Blockly.Msg.ROBOT_DOWN_DESCRIPCION = "Mueve los servos hacia atras";
Blockly.Msg.ROBOT_RIGHT = "Derecha    ";
Blockly.Msg.ROBOT_RIGHT_DESCRIPCION = "Gira el robot hacia la derecha";
Blockly.Msg.ROBOT_LEFT = "Izquierda   ";
Blockly.Msg.ROBOT_LEFT_DESCRIPCION = "Gira el robot hacia la izquierda";
Blockly.Msg.ROBOT_STOP = "Detener    ";
Blockly.Msg.ROBOT_STOP_DESCRIPCION = "Detiene el robot";

Blockly.Msg.ROBOT_BRAZOS_DERECHO = "Brazo Derecho   PIN#";
Blockly.Msg.ROBOT_BRAZOS_IZQUIERDO = "Brazo Izquierdo  PIN#";
Blockly.Msg.ROBOT_BRAZOS_SUBIR = "Subir brazo ";
Blockly.Msg.ROBOT_BRAZOS_BAJAR = "Bajar brazo ";
Blockly.Msg.ROBOT_BRAZO_DERECHO = "Derecho";
Blockly.Msg.ROBOT_BRAZO_IZQUIERDO = "Izquierdo";
Blockly.Msg.ROBOT_BRAZO_AMBOS = "Ambos";
Blockly.Msg.ROBOT_BRAZOS_UP = "Levantar Brazos";
Blockly.Msg.ROBOT_BRAZOS_UP_DESCRIPCION = "Levanta los brazos del robot";
Blockly.Msg.ROBOT_BRAZOS_DOWN = "Bajar Brazos     ";
Blockly.Msg.ROBOT_BRAZOS_DOWN_DESCRIPCION = "Baja los brazos del robot";



Blockly.Msg.BORRAR_BLOQUES = "Borrar los ";
Blockly.Msg.BORRAR_BLOQUES_2 = " bloques?";
