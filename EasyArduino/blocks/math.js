...
Blockly.Blocks['random'] = {
		  ...
		  init: function() {
		    ...
		    this.appendValueInput("DMAX", 'Number')
		        .appendField(Blockly.Msg.RANDOM_AND)
		        .setCheck('Number');
		    this.setInputsInline(true);
		    this.setOutput(true);
		    this.setTooltip(Blockly.Msg.RANDOM_DESCRIPCION);
		  }
};
...
Blockly.Blocks['base_map'] = {
  ...
  init: function() {
    this.setColour(230);
    this.appendValueInput("NUM", 'Number')
        .appendField(Blockly.Msg.MAPEAR)
        .setCheck('Number');
    this.appendValueInput("DMAX", 'Number')
        .appendField(Blockly.Msg.MAPEAR_VALOR)
        .setCheck('Number');
    this.appendDummyInput()
	      .appendField("]");
    this.setInputsInline(true);
    this.setOutput(true);
    this.setTooltip(Blockly.Msg.MAPEAR_DESCRIPCION);
  }
};
